...
export class RoleGuard implements CanActivate {
  ...
  canActivate(
    ...
    const userRoles = this._msalService.instance.getAllAccounts()[0]?.idTokenClaims?.roles; //This needs to changed to where the Account is pulled based on Local Id
